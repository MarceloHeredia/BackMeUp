...
public class NavigationViewHeaderBehavior(IApplicationService applicationService) : Behavior<NavigationView>
{
    ...
    public static readonly DependencyProperty HeaderModeProperty =
        DependencyProperty.RegisterAttached("HeaderMode", typeof(bool), typeof(NavigationViewHeaderBehavior), new(NavigationViewHeaderMode.Always, (d, e) => _current!.UpdateHeader()));
