...
public class NavigationViewHeaderBehavior(IApplicationService applicationService) : Behavior<NavigationView>
{
    ...
    public static readonly DependencyProperty DefaultHeaderProperty =
        DependencyProperty.Register(nameof(DefaultHeader), typeof(object), typeof(NavigationViewHeaderBehavior), new(null, OnHeaderChanged));
    ...
    public static readonly DependencyProperty HeaderModeProperty =
        DependencyProperty.RegisterAttached("HeaderMode", typeof(bool), typeof(NavigationViewHeaderBehavior), new PropertyMetadata(NavigationViewHeaderMode.Always, OnHeaderChanged));
    ...
    public static readonly DependencyProperty HeaderContextProperty =
        DependencyProperty.RegisterAttached("HeaderContext", typeof(object), typeof(NavigationViewHeaderBehavior), new(null, OnHeaderChanged));
    ...
    public static readonly DependencyProperty HeaderTemplateProperty =
        DependencyProperty.RegisterAttached("HeaderTemplate", typeof(DataTemplate), typeof(NavigationViewHeaderBehavior), new(null, OnHeaderChanged));
    ...
    private void OnNavigated(object sender, CustomNavigationEventArgs e)
    {
    ...
    {
        if (d is NavigationViewHeaderBehavior behavior)
        {
